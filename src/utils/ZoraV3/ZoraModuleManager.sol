...
import {ZoraProtocolFeeSettings} from "./auxiliary/ZoraProtocolFeeSettings.sol";
...
contract ZoraModuleManager {
    ...
    modifier onlyRegistrar() {
        require(
            ...
            "ZMM::onlyRegistrar must be registrar"
        );
        _;
    }
    ...
    constructor(address _registrar, address _feeToken) {
        require(
            ...
            "ZMM::must set registrar to non-zero address"
        );
    ...
    function setApprovalForModuleBySig(
        ...
        require(
            ...
            "ZMM::setApprovalForModuleBySig deadline expired"
        );
    ...
    function registerModule(address _module) public onlyRegistrar {
        require(
            ...
            "ZMM::registerModule module already registered"
        );
    ...
    function setRegistrar(address _registrar) public onlyRegistrar {
        require(
            _registrar != address(0),
            "ZMM::setRegistrar must set registrar to non-zero address"
        );
        registrar = _registrar;
